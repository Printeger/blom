...
def main() -> None:
    ...
    result = run_boundary_jump_check(q, T, scheme="A", save_dir=DEFAULT_RESULTS_DIR)
    print("Phase 5 demo scheme A")
    print(f"max lower-order jump: {result['stats_overview']['lower_order_max']:.3e}")
    print(f"hessian condition number: {result['system']['condition_number']:.3e}")
